...
const EVENTS_DB = {
  "math-academy-top1": {
    ...
    date: "녹화본 4회차 · 신청 후 바로 시청",
    thumb: "assets/events/math-academy-top1/hero.png",
    format: "online",
    priceType: "paid",
    price: 80000,
    feeNote: "4회차 녹화영상 전체와 강의자료 포함",
    provision: "결제를 마치시면 시청용 비밀번호를 보내드립니다. 시청 기간에 제한은 없습니다.",
    refundNote: "시청용 비밀번호를 받기 전까지는 전액 환불해 드립니다. 비밀번호를 받으신 뒤에는 영상 전체를 이미 보실 수 있는 상태라 환불이 어렵습니다.",
    desc: "AI 시대, 살아남는 학원이 아니라 선택받는 학원을 만드는 4주 실전 프로젝트입니다. 4년 만에 지점 7개까지 늘린 올마이티캠퍼스 여호원 대표가 지역 1등 수학학원의 성장 시스템을 전부 공개합니다. 라이브로 진행한 4회차를 녹화본으로 만나보세요.",
    points: [
      "AI가 바꾸는 학원의 미래와 원장의 역할 이해하기",
      "원장이 없어도 굴러가는 관리 시스템 만들기",
      "모집부터 상담까지 등록률을 높이는 구조 세우기",
      "AI로 문제 제작과 업무를 자동화해 하루 3시간 줄이기"
    ],
    speaker: "여호원",
    ...
    sessions: [
      ...
      {
        no: "04",
        title: "AI로 하루 3시간을 줄이는 수학학원 업무 자동화",
        speaker: "여호원",
        speakerRole: "수학문제는 AI로 생성이 안 된다구요? 가능합니다",
        points: [
          "AI 활용 변형문제 제작",
          "학교별 맞춤 변형문제 만들기",
          "수준별 문제와 해설지 자동 제작",
          "오답노트 및 복습자료 제작",
          "Gemini와 NotebookLM 실전 활용법"
        ],
        poster: "assets/events/math-academy-top1/session-04.png"
      }
    ],
    materials: [
      { name: "4회차 녹화영상 전체" },
