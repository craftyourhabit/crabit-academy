...
const EVENTS_DB = {
  ...
  "ai-ace-webinar": {
    ...
    thumb: "assets/events/ai-ace-webinar/hero.jpg",
    /* 일러스트 위 글자는 AI가 그린 글자 대신 실제 프리텐다드로 얹는다. assets/events.js 주석 규칙 참고. */
    coverOverlay: {
      theme: "navy",
      lines: [
        { text: "AI ACE", size: "huge" },
        { text: "적성진로", size: "title" },
        { text: "교육전문가 과정", size: "title" }
      ]
    },
    format: "online",
    priceType: "free",
    ...
    article: [
      { type: "img", src: "assets/events/ai-ace-webinar/illustration-intro.jpg", alt: "상담 테이블에 마주 앉은 학부모와 원장님, 그 사이에 적성진단 리포트가 놓인 일러스트", caption: "학부모와 학생, 원장님이 같은 데이터를 보고 이야기하는 상담으로." },
      { type: "h", icon: "target", text: "학부모님의 첫 질문이 달라지고 있습니다" },
      { type: "p", text: "\"성적 얼마나 올려주시나요\"에서 \"우리 아이가 뭘 잘하고, 어느 방향으로 가야 하나요\"로. 이 변화는 우연이 아니라 제도가 만들어낸 흐름입니다." },
      ...
      { type: "banner", theme: "navy", icon: "assets/events/ai-ace-webinar/icon-ai-graph.png",
        headline: "\"성적 얼마나 올려주시나요\"에서\n**\"우리 아이가 뭘 잘하고, 어느 방향으로 가야 하나요\"**로" },
      { type: "img", src: "assets/events/ai-ace-webinar/card-1-shift.jpg", alt: "성적을 확인하는 돋보기 아이콘이 방향을 가리키는 나침반 아이콘으로 바뀌는 일러스트", caption: "상담의 무게중심이 \"성적 확인\"에서 \"방향 제시\"로 옮겨가고 있습니다." },
      { type: "h", icon: "bulb", text: "앱티핏(Aptifit), 감이 아니라 데이터로 답하는 상담" },
      { type: "p", text: "서울대학교 기술지주 자회사 앱티마이저가 개발한 AI 적성진단 서비스 **앱티핏(Aptifit)**은 약 20분 진단으로 학생의 학습 성향과 강·약점을 분석하고, 적합한 전공과 학습 방향까지 제안합니다. 이 진단을 학원 상담에 실제로 접목하는 법을 배우는 과정이 바로 AI 적성진로교육전문가과정(AI ACE)입니다." },
      { type: "img", src: "assets/events/ai-ace-webinar/card-2-report.jpg", alt: "학생의 강점과 약점을 진단하는 리포트 안에 작은 레이더 차트가 그려진 아이콘", caption: "적성진단 데이터가 쌓일수록, 상담의 근거도 선명해집니다." },
      { type: "h", icon: "gift", text: "이 웨비나에서 미리 만나보실 것" },
      { type: "p", text: "9월 정식 AI ACE 과정에 앞서, 크래빗이 핵심만 압축해 무료로 안내해 드립니다. 왜 지금 적성 기반 상담이 필요한지부터, 실제 도입 학원의 성과, 정식과정 참가 혜택까지 한 번에 확인하실 수 있어요." },
      { type: "img", src: "assets/events/ai-ace-webinar/illustration-benefits.jpg", alt: "선물 상자, 학사모, 말풍선, 달력 아이콘이 나란히 떠 있는 일러스트", caption: "무료 체험 계정부터 얼리버드 혜택까지, 웨비나 참여자에게만 따로 챙겨드려요." },
      { type: "steps", items: [
        "웨비나 신청하고 참여 링크 받기",
        "앱티핏 AI 적성진단 무료 체험 계정으로 직접 진단해보기",
        "9월 AI ACE 정식과정 얼리버드 혜택으로 등록하기"
      ] }
    ],
    points: [
      ...
      "9월 AI ACE 정식과정 커리큘럼과 참가 혜택 미리보기"
    ],
    speaker: "크래빗 아카데미팀",
    ...
    materialsTitle: "웨비나 참여 혜택",
    materialsSub: "무료로 참여하신 원장님께 드리는 자료입니다.",
    materials: [
      { name: "앱티핏 AI 적성진단 무료 체험 계정", note: "웨비나 참여자 한정 1회 진단" },
      { name: "AI ACE 정식과정 요약 자료집" },
      { name: "실제 도입 학원 성과 사례 모음" },
      { name: "9월 AI ACE 정식과정 얼리버드 등록 혜택 안내" }
    ],
    curriculumIntro: {
      eyebrow: "9월 정식 과정 전, 핵심만 먼저 만나보세요",
      question: "우리 학원 상담,\n감이 아니라 데이터로 바뀔 수 있을까요?",
      pains: [
        "성적 관리는 잘하는데 진로·적성 상담엔 자신이 없는 학원",
        "학부모 질문이 \"방향\"으로 바뀌었는데 아직 \"성적\"으로만 답하는 학원",
        "AI 적성진단이 궁금하지만 어디서부터 봐야 할지 모르는 학원"
      ]
    },
    sessions: [
      {
        no: "1부",
        title: "왜 지금 적성 기반 진로교육인가",
        sub: "고교학점제, 2028 대입개편, 무전공 확대가 만든 학원 상담의 변화",
        points: [
          "고1부터 시작되는 고교학점제와 192학점 선택의 무게",
          "2028 대입개편, 진로·적성에 따른 이수 내역까지 평가하는 주요 대학들",
          "\"일찍 진로를 정하라\"와 \"전공 없이 뽑는다\" 사이, 학부모의 혼란",
          "AI 중점학교 확대까지, 국가 차원에서 밀어붙이는 AI 전환"
        ]
      },
      {
        no: "2부",
        title: "앱티핏(Aptifit)과 AI ACE 과정 소개",
        sub: "20분 진단으로 강약점부터 전공 제안까지, 실제 상담에 접목하는 법",
        points: [
          "서울대 기술지주 자회사 앱티마이저가 개발한 AI 적성진단 서비스",
          "약 20분 진단으로 학습 성향과 강·약점, 적합 전공까지 한 번에",
          "\"경험과 감\"에서 \"AI가 증명하는 객관적 지표\"로 바뀌는 상담",
          "AI ACE 과정 커리큘럼과 수료 시 받는 혜택 미리보기"
        ]
      },
      {
        no: "3부",
        title: "먼저 도입한 학원들의 성과",
        sub: "송파·판교, 광교, 대치동부터 전북 전주까지 이어진 변화",
        points: [
          "송파·판교 B영어학원, 상담 성공률 상승과 신규 원생 확대",
          "광교 A수학·B국어학원, 도입 2개월 만에 100명 넘는 상담 신청",
          "대치동부터 전북 전주까지, 전국 각지 학원들의 도입 확산",
          "\"비용\"이 아니라 \"성장 투자\"로 이어지는 하나의 도구"
        ]
      },
      {
        no: "4부",
        title: "9월 AI ACE 정식과정 안내 & Q&A",
        sub: "커리큘럼, 참가비, 얼리버드 신청 방법까지 한 번에",
        points: [
          "정식과정 커리큘럼과 하루 일정 미리보기",
          "수료 시 주어지는 '멤버십 학원' 자격과 1년 특별가 혜택",
          "웨비나 참여자만 받는 얼리버드 등록 혜택",
          "실시간 Q&A로 궁금한 점 바로 해소"
        ]
      }
    ]
  },
  "daegu-landing-lecture": {
    ...
    place: "대구학원연합회, 대구 달서구 상화북로 191, 6층",
    placeUrl: "https://naver.me/5vczvOjM",
    thumb: "assets/events/daegu-landing-lecture/hero.jpg",
    /* 일러스트 위 글자는 AI가 그린 글자 대신 실제 프리텐다드로 얹는다. */
    coverOverlay: {
      theme: "white",
      eyebrow: "대구학원연합회 원장님 실습 강의",
      lines: [
        { text: "원장님이", size: "title" },
        { text: "직접 만드는", size: "title" },
        { text: "우리 학원 랜딩페이지", size: "title", accent: true }
      ]
    },
    format: "offline",
    priceType: "free",
    ...
    article: [
      ...
      { type: "banner", theme: "navy",
        headline: "**노트북 하나만** 가져오시면\n기획부터 디자인, 실제 페이지 제작까지\n직접 따라오실 수 있습니다" },
