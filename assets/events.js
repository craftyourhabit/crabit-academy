...
const EVENTS_DB = {
  ...
  "math-academy-top1": {
    ...
    provision: "결제를 마치시면 시청 페이지 주소와 비밀번호, 강의자료를 모두 즉시 보내드립니다. 영상은 내려받는 것이 아니라 사이트 안에서 재생합니다. 서비스 제공은 이 시점에 완료됩니다. 시청 페이지는 회사가 서비스를 운영하는 동안 이용하실 수 있습니다. 8월 29일 오프라인 현장탐방은 녹화본에 포함되지 않습니다.",
    ...
    status: "upcoming",
    materials: [
      { name: "온라인 강의 3회차 녹화영상", note: "사이트 안에서 재생, 내려받지 않습니다" },
