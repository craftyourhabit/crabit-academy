...
const EVENTS_DB = {
  ...
  "math-academy-top1": {
    ...
    provision: "결제를 마치시면 시청 페이지 주소와 비밀번호, 강의자료를 바로 보내드립니다. 결제하신 날부터 3개월 동안 시청하실 수 있어요. 그 기간에는 받으신 주소로 언제든 다시 들어와 보실 수 있습니다. 8월 29일 오프라인 현장탐방은 녹화본에 포함되지 않습니다.",
    ...
    status: "upcoming",
    materials: [
      { name: "온라인 강의 3회차 녹화영상", note: "결제일부터 3개월 동안 시청" },
  ...
  "olkeoni-landing-vod": {
    ...
    provision: "결제를 마치시면 시청 페이지 주소와 비밀번호를 바로 보내드립니다. 결제하신 날부터 3개월 동안 시청하실 수 있어요. 그 기간에는 받으신 주소로 언제든 다시 들어와 보실 수 있고, 강의 슬라이드와 프롬프트 자료도 같은 페이지에 모여 있습니다.",
    refundNote: "시청용 비밀번호를 받기 전까지는 전액 환불해 드립니다. 비밀번호를 받으신 뒤에는 영상 전체를 이미 보실 수 있는 상태라 환불이 어렵습니다.",
    ...
    status: "upcoming",
    materials: [
      { name: "특강 녹화영상 (1시간 43분)", note: "결제일부터 3개월 동안 시청" },
      { name: "강의 슬라이드" },
  ...
  "ai-ace-webinar": {
    ...
    article: [
      ...
      { type: "p", text: "우리 학원에 맞는 과정인지, 이 웨비나에서 먼저 확인해 보세요." },
  ...
  "olkeoni-blackfriday-0918": {
    ...
    host: "올커니 × 크래빗",
    kind: "교육",
    title: "원장님이 직접 만드는 우리 학원 랜딩페이지 2탄 | 올커니 BLACK FRIDAY",
    date: "2026.09.18 (금) 밤 10:30 | 온라인",
    startDate: "2026-09-18",
    thumb: "assets/events/olkeoni-blackfriday-0918/hero.jpg?v=6",
    format: "online",
    priceType: "free",
