...
| 페이지 | 임시 비밀번호 | 경로 |
|---|---|---|
| 대구 강의 자료 | `crabit2026` | `p/abb98caa078a9366/` |
| 웨비나 다시보기 전체 | `webinar2026` | `p/06960032d8b6bc15/` |
| 자료 / 인사이트 전체 | `archive2026` | `p/580672051e6003c6/` |

홈의 "전체보기" 버튼과 잠긴 자료 항목은 모두 같은 비밀번호 모달을 사용합니다. 입력한 비밀번호에 해당하는 페이지가 존재하면 그리로 이동합니다.
