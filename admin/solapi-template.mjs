...
const DRAFTS = {
  ...
  payment_guide: {
    ...
    content: [
      "안녕하세요, 원장님! 크래빗팀입니다.",
      "",
      "#{강의명} 신청해 주셨는데 아직 결제가 확인되지 않았어요.",
      "",
      "■ 일시  #{일시}",
      "■ 수강료  #{수강료}",
      "",
      "#{마감일}까지 확인되지 않으면 자리가 다음 분께 넘어갑니다.",
      "혹시 사정이 있으시면 편하게 알려 주세요.",
      "",
      "#{문의처}"
    ].join("\n"),
    buttons: [
  ...
  vod_access: {
    ...
    content: [
      ...
      "■ 시청 기간  #{시청마감일}까지",
      "",
      "기간 안에 영상 파일을 내려받아 두시면",
      "그 뒤로도 기간 제한 없이 보실 수 있어요.",
      "마감일이 지나면 시청 페이지는 닫힙니다.",
      "",
      "강의자료도 같은 페이지에 함께 있습니다.",
